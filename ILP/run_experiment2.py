"""
Run (d,l)-disjunct ILP experiments — second half of graphs (sorted alphabetically).
Results saved to Using_DDDisjunct_result2.txt.
Run alongside run_experiment1.py in a separate terminal for parallel coverage.
...
def run_experiments() -> None:
    ...
    print(f"Total graphs  : {len(all_graphs)}  (this file: last {len(all_graphs) - half})")
...
def write_report() -> None:
    ...
    lines = [
        "=" * 72,
        "EXPERIMENT REPORT — (d,l)-Disjunct ILP Sensor Set Finder (Part 2)",
